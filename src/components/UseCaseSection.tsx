  ...
  return (
    <section className="section usecaseSection" id="casos">
      ...
      <div className="usecaseCta">
        ...
        <a href="https://wa.me/541170605707?text=Hola%2C%20quiero%20consultar%20por%20un%20tr%C3%A1mite%20espec%C3%ADfico." target="_blank" rel="noopener noreferrer" className="usecaseCtaBtn">PEDÍ TU TRÁMITE <span aria-hidden="true">→</span></a>
      </div>
    </section>
  );
};
